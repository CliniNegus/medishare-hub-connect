...
import { Package, Cpu, FileSpreadsheet } from 'lucide-react';
      ...
      <div className="container mx-auto p-6 max-w-6xl">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            Bulk upload your products and equipment using CSV files. Download templates, validate data, and import in one go.
          </p>
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Choose the type of catalog you want to upload. Make sure to use the correct template for each type.
            </CardDescription>
          </CardHeader>
          <CardContent>
