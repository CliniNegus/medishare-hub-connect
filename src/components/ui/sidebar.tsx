      ...
      return (
        <>
          ...
          <div
            ...
            data-mobile="true"
            className={cn(
              "fixed top-0 left-0 z-50 h-full w-[--sidebar-width] bg-sidebar text-sidebar-foreground transform transition-transform duration-300 ease-in-out lg:hidden shadow-2xl",
